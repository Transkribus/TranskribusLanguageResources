...
public class OutOfVocabularyCalculationTest
{
    ...
    public void outOfVocabularyByTypeTest()
    {
        ...
        double outOfVocabularyRate1 = OutOfVocabularyRate.byTypes(smallDictionary1, tokenizedText);
        double outOfVocabularyRate2 = OutOfVocabularyRate.byTypes(smallDictionary2, tokenizedText);
        double outOfVocabularyRate3 = OutOfVocabularyRate.byTypes(smallDictionary3, tokenizedText);
        double outOfVocabularyRate4 = OutOfVocabularyRate.byTypes(smallDictionary4, tokenizedText);
    ...
    @Test
     public void outOfVocabularyByTokenTest()
     {
         ...
         double outOfVocabularyRate1 = OutOfVocabularyRate.byTokens(smallDictionary1, tokenizedText);
         double outOfVocabularyRate2 = OutOfVocabularyRate.byTokens(smallDictionary2, tokenizedText);
         double outOfVocabularyRate3 = OutOfVocabularyRate.byTokens(smallDictionary3, tokenizedText);
         double outOfVocabularyRate4 = OutOfVocabularyRate.byTokens(smallDictionary4, tokenizedText);
